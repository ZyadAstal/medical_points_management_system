@php
    ...
    $initials = mb_substr($receptionName, 0, 1) . mb_substr($receptionName, mb_strpos($receptionName, ' ') + 1, 1);
@endphp
        ...
        <div class="header-v2__user">
            ...
            <div class="header-v2__menuWrap">
                ...
                <div class="header-v2__userDropdown" id="userDropdown" aria-hidden="true">
                    ...
                    <img class="user-dd__logoutIcon" src="{{ asset('assets/reception/icons/exit.svg') }}" alt="" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" />
                </div>
            </div>
        </div>
