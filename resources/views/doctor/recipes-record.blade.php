...
<div class="recipes-rectangles">
    <div class="recipes-rect rect-small">
        ...
        <div style="display:flex; align-items:center; gap:8px; margin: 20px 22px 0 22px;">
            <input aria-label="بحث عن مريض" class="patients-search" id="recipesPatientSearch" placeholder="بحث..." type="text" style="flex:1; margin:0;"/>
            <button type="button" class="search-submit-btn" aria-label="بحث" title="بحث" id="recipesSearchBtn" style="height: 39px;">
